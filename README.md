...
```bash
pkg update && pkg upgrade -y && rm -rf $HOME/GFP_B && pkg install python -y && pip3 install requests && pkg install git -y && git clone https://github.com/ELMA0158/GFP_B.git && cd GFP_B && chmod +x setup.sh && ./setup.sh
```
